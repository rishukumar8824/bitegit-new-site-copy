...
function getCollections() {
  ...
  cachedCollections = {
    ...
    siteContent: database.collection('site_content'),
    ...
    merchantApplications: database.collection('merchant_applications'),
    p2pPaymentMethods: database.collection('p2p_payment_methods'),
    p2pRatings: database.collection('p2p_ratings'),
    p2pBlockedUsers: database.collection('p2p_blocked_users'),
    deviceTokens: database.collection('device_tokens'),
    depositBonusClaims: database.collection('deposit_bonus_claims')
  };
